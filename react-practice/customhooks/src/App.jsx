...
function App() {
  ...
  // Log to check the actual values of data, loading, error
  console.log("currencyInfo:", currencyInfo);
  console.log("loading:", loading);
  console.log("error:", error);

  let options = currencyInfo ? Object.keys(currencyInfo) : [];
  ...
  const convert = () => {
    if (currencyInfo && currencyInfo[to]) {
        setConvertedAmount(amount * currencyInfo[to]);
          ...
          setConvertedAmount(0); // Handle cases where conversion info is missing
      }
  };
